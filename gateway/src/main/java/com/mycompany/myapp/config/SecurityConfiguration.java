...
public class SecurityConfiguration {
    ...
    public ReactiveJwtDecoder jwtDecoder() {
        return ReactiveJwtDecoders.fromIssuerLocation("http://localhost:8002/realms/jhipster");
    }
...
//        Mono<ClientRegistration> clientRegistration = registrations.findByRegistrationId("keycloak");
//
//        return clientRegistration
//            .map(keycloak ->
//                createJwtDecoder(
//                    keycloak.getProviderDetails().getIssuerUri(),
//                    keycloak.getProviderDetails().getJwkSetUri(),
//                    keycloak.getProviderDetails().getUserInfoEndpoint().getUri()
//                )
//            )
//            .block();
//    }
